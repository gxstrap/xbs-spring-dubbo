...
public class RedisOpsSet extends BaseRedisCache{
	...
	public Set<String> zrangeByScore(final String key, final String min, final String max){
		return redisGeneric.getJedisCluster().zrangeByScore(key, min, max);
	}
	...
	public Set<String> zrevrangeByScore(final String key, final double max, final double min) {
		return redisGeneric.getJedisCluster().zrevrangeByScore(key, min, max);
	}
	...
	public Set<Tuple> zrevrangeWithScores(final String key, final long start, final long end) {
		return redisGeneric.getJedisCluster().zrevrangeWithScores(key, start, end);
	}
